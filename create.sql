...
create table queuerlolaccounts (id  bigserial not null, lpq varchar(255), account varchar(255), be int4, champ varchar(255), lane int4, level int4, max_level int4, xp int4, xp_cap int4, queuerid int8 not null, primary key (id))
