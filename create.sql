...
create table infernalsettings (id  bigserial not null, aktive boolean, auto_bot_start boolean, auto_login boolean, client_hide boolean, client_path varchar(255), client_version varchar(255), console_hide boolean, cpu_boost boolean, dis_chest boolean, enable_auto_export boolean, exportbe boolean, export_level boolean, export_path varchar(255), export_region boolean, export_wild_card varchar(255), groups int4, leader_cpu_boost boolean, leader_hide boolean, leader_render_disable boolean, level_to_beginner_bot int4, lol_height int4, lol_width int4, max_be int4, max_level int4, open_chest boolean, open_hex_tech boolean, play_time int4, prio int4, queue_close_value int4, queuer_auto_close boolean, ram_manager boolean, ram_max int4, ram_min int4, region int4, render_disable boolean, replace_config boolean, sets varchar(255), sleep_time int4, soft_end_default boolean, soft_end_value int4, surrender boolean, time_span int4, time_until_check boolean, time_until_reboot varchar(255), timeout_champ int4, timeout_end_of_game int4, timeout_in_game int4, timeout_in_gameff int4, timeout_load_game int4, timeout_lobby int4, timeout_login int4, timeout_mastery int4, wildcard varchar(255), win_reboot boolean, win_shutdown boolean, userid int8, primary key (id))
