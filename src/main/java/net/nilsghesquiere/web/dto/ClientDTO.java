...
public class ClientDTO implements Serializable{
	...
	public ClientDTO(Long id, String tag, String HWID, Long clientSettings,
			Long infernalSettings, ClientStatus clientStatus, ClientAction clientAction, Boolean error, String timeSinceLastPing) {
		super();
		this.id = id;
		this.tag = tag;
	...
	public ClientDTO(Client client){
		...
		this.clientAction = client.getClientAction();
